...
////////////////////////
			printf("i=%d\tbranch 1, m=%d, len=%d, p=%d, s=%d, w=[", i, midword, wordlength, placement, save_at);
			for (int k=0; k < save_at; k++){
				if (word[k] == '\0')
					printf("n, ");
				else
					printf("'%c', ",word[k]);
...
////////////////////////
		printf("i=%d\tbranch 2, m=%d, len=%d, p=%d, s=%d, w=[", i, midword, wordlength, placement, save_at);
		for (int k=0; k < save_at; k++){
			if (word[k] == '\0')
				printf("n, ");
			else
